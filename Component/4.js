...
export default class YouTubeExample3 extends Component {
state = {
  isReady: false,
  status: null,
  quality: null,
...
render(){
  const YOUR_API_KEY = "AIzaSyBBgc-Us6_79oJmGYC6rjTFMoRrA5OQNLo";

 return (<View>
      <ScrollView style={styles.container}>
        <Text style={styles.welcome}>{'Exercise 3'}    </Text>
    <YouTube
